     ...
     <div className="container">
            ...
            <div className="row">
                <div className="col-md-5">
                    <div className="card">
                        <div className="card-header bg-primary text-white" bg-secondary text-white>
                        ...
                        <div className="card-body">
                            <form onSubmit={submitHandler}>
                                ...
                                <div className="form-group">
                                    <input type="number" name="price" onChange={updateInput} value={product.price} placeholder="Price" className="form-control"/>
                                </div>
                                <div className="form-group">
                                    <input type="number" name="qty" onChange={updateInput} value={product.qty} placeholder="qty" className="form-control"/>
                                </div>
                                <div className="form-group">
                                    <input type="text" name="info" onChange={updateInput} value={product.info} placeholder="Additional Info" className="form-control"/>
                                </div>
